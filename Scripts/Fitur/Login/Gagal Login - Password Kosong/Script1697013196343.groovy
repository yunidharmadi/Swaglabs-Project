...
WebUI.verifyElementVisible(findTestObject('Object Repository/Login/label password required'))

WebUI.clearText(findTestObject('Object Repository/Login/Username'))
