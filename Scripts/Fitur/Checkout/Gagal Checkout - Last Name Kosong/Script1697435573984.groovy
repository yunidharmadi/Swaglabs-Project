...
WebUI.setText(findTestObject('Object Repository/Checkout/Last Name'), '')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Checkout/h3_Error Last Name is required'), 0)
