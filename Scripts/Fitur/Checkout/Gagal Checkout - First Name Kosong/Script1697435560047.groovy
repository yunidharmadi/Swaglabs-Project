...
WebUI.setText(findTestObject('Object Repository/Checkout/First Name'), '')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Checkout/h3_Error First Name is required'), 0)
